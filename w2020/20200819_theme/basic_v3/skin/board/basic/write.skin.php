...
<section id="bo_w">
    ...
    <?php } ?>
    <div class="write_tel">
        <label for="wr_tel" class="sound_only">전화번호</label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" size="50" placeholder="01063122222">
    </div>
